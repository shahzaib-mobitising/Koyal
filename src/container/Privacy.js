        ...
        <div className="PrivacyPolicy">
            ...
            <p>
                <p>
                    ...
                    to the collection, use, disclosure, transfer of your data by
                    Koyal.pk, and/or its subsidiary (ies) and/or affiliate(s)
                    (collectively referred to as the Company), which operates the
                    website (“Site”), applications and other services including but
                    not restricted to delivery of music and related content through
                    the site or any mobile or internet associated device or
                    something else (collectively the "koyal.pk Service"). This
                    Security Policy forms part and parcel of the “Terms of Use” for
                    the koyal.pk capitalized terms which have been used here but are
                    indistinct shall have the same meaning as attributed to them in
                    the “Terms of Use”.
             </p>
                <p className="top">
                    As we upgrade, improve and expand the koyal.pk, this policy may
                    change, so please refer back to it periodically. By accessing the
                    site or something else using the Koyal.pk you consent to the
                    collection, capacity, and utilize of the individual data you give
                    (including any changes thereto as given by you) for any of the
                    services that we offer.
            </p>
                <p className="top">`The Company regards the security of the users of the koyal.pk and is committed to sensibly ensure it in all respects.</p>
                ...
                <p> All required data is service dependent and the Company may utilize the above said user Information to maintain, ensure, and improve the koyal.pk (including advertising on the Site) and for creating new services. We may use your e-mail address or other personally identifiable data to send commercial or promotion messages without your consent [with a choice to subscribe / unsubscribe (where feasible)]. We may, however, use your mail address without further consent for non-marketing or authoritative purposes.

        </p>
                <h3>Cookies</h3>
                <p>To improve the responsiveness of the Site for our clients, we may utilize "cookies", or comparative electronic tools to gather data to assign each guest a unique random number as a User Identification (User ID) to understand the user's interests using the recognized computer. Unless you deliberately recognize yourself (through registration, for example), we will have no way of knowing who you are, even if we assign a cookie to your computer. The only personal data a cookie can contain is information you supply. A cookie cannot read data off your hard drive. Our sponsors may also assign their own cookies to your browser if you tap on their ads (a process that we don't control).</p>
                <h3>Log File Information</h3>
                <p>Our web servers automatically collect limited information about your computer's connection to the Internet (including your IP address) when you visit our site. Your IP address is a number that lets computers attached to the Internet in order to know where to send your data -- such as the web pages you view. We automatically receive and log information from your browser, including your IP address, your computer's name, your operating system, browser type and version, CPU speed, and connection speed. We may also collect log in information from your device, including your location, IP address, your device’s name, device’s serial number or unique identification number (e.g. UDiD on your iOS device), your device operating system, browser type and version, CPU speed, and connection speed etc.</p>
